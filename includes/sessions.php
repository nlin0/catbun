...
?>
  ...
  <form class="login" action="<?php echo htmlspecialchars($action) ?>" method="post" novalidate>
    <div class="label-input">
      ...
      <input id="username" placeholder="Username" type="text" name="login_username" value="<?php echo htmlspecialchars($sticky_login_username ?? ""); ?>" required />
    </div>

    <div class="label-input">
      <label for="password">Password:</label>
      <input id="password" placeholder="Password" type="password" name="login_password" required />
    </div>
